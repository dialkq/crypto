$(document).ready(function () {
    ...
    new Tabulator("#expert-table", {
      ajaxURL: 'https://vietexpert-api.d.logique.co.id/api/admin/company',
      ajaxConfig: {
      ...
      columns: [
        ...
        { title: "Date of Establishment", field: "date_of_establishment" },
        { title: "Company Name", field: "company_name_eng" },
        {
          title: "",
