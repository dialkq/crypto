$(document).ready(function () {
    ...
    new Tabulator("#administrator-table", {
      ajaxURL: 'https://vietexpert-api.d.logique.co.id/api/admin/user',
      ajaxConfig: {
      ...
      layout: "fitColumns",
      columns: [
        { title: "Identification", field: "id" },
        {
            title: "Admin Name", formatter: function (cell, formatterParams, onRendered) {
              var data = cell.getRow().getData();
              var fullName = data.first_name + " " + data.last_name;
              return fullName;
            }
          },
        { title: "Mail Adress", field: "email" },
        {
          title: "",
